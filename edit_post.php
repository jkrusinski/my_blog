    ...
    <body>
                        ...
                        <div class="panel panel-info" id="edit-panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="title" value="<?php echo $post->pTitle; ?>" class="form-control" id="input-title" autocomplete="off">
                                    </div>
                                </div>
                                            ...
                                            <div id="tag_box" class="panel-body">
                                                ...
                                                if (isset($post)){ //if edit_post.php... send postID number
                                                    ...
                                                    foreach($post->pTags as $key => $value){
                                                        echo "<span class='tag visible btn btn-default' id='pTag$key'>$value</span>";
                                                    }
                                                }
                                                ?>
                                            </div>
        ...
        <div id="cancel-edit-warning" class="hidden">
            <div class="panel panel-danger col-xs-10 col-sm-4">
                ...
                <div class="panel-footer">
                    <button class="btn btn-danger delete" data-postid="<?php echo $_GET['postid']; ?>" id="confirm-cancel">I'm sure</button>
