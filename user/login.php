                        ...
                        <div class="panel panel-info" id="login-panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="input-group bottom-space">
                                    <div class="input-group-addon" id="input-username"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></div>
                                    <input type="text" name="username" class="form-control" placeholder="Username" aria-describedby="input-username"><br />
                                </div>

                                <div class="input-group">
                                    <div class="input-group-addon" id="input-password"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></div>
                                    <input type="password" name="password" class="form-control" placeholder="Password" aria-describedby="input-password" autocomplete="off"><br />
                                </div>
